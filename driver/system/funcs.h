...
namespace system
{
	...
	static uintptr_t find_pattern(uintptr_t base, size_t range, const char* pattern, const char* mask)
	{
	...
	static uintptr_t find_pattern(uintptr_t base, const char* pattern, const char* mask)
	{
	...
	static uintptr_t find_pattern(uintptr_t module_base, const char* pattern)
	{
